...
if not st.session_state.logged_in and not st.session_state.get("admin_logged_in", False):
    ...
    if lang_choice == "English":
        ...
        with public_menu[1]:
            ...
            except: st.warning("⚠️ Place 'deltacoreApp.jpeg' in root folder.")
        ...
        with public_menu[0]:
            ...
            <div class="content-card">
                <h3>2. हाइब्रिड इंटेलिजेंस इंजन (चार्ट + डेरिवेटिव्स)</h3>
                <p>यह इंजन लाइव चार्ट और PCR (Put-Call Ratio) का विश्लेषण करके सही स्ट्राइक, टारगेट और स्टॉप-लॉस सुझाता है।</p>
            </div>

            <div class="content-card">
                <h3>3. मनोवैज्ञानिक सुरक्षा और रिस्क मैनेजमेंट</h3>
                <p><b>हार्ड-लॉक किल-सविच:</b> दैनिक नुकसान की सीमा पार होने पर ट्रेडिंग को तुरंत फ्रीज कर देता है, जिससे रिवेंज ट्रेडिंग रुकती है।</p>
            </div>

            <div class="content-card">
                <h3>4. एआई पोस्ट-मॉर्टम P&L एनालिटिक्स</h3>
